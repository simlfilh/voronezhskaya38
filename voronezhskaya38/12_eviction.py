...
st.markdown("""
    ...
    <div class="colored-container">
        ...
        <p><b>1.</b> Написать заявление на выезд у заведующего общежитием.</p>
        <p><b>2.</b> Погасить задолженность за проживание в общежитии.</p>
        <p><b>3.</b> Получить обходной лист.</p>
        <p><b>4.</b> Заполнить обходной лист (заведующий общежитием, 
        Жилищно-бытовое управление (кабинет №1 и №5), Бюро пропусков, бельевая, камера хранения).</p>
        <p><b>5.</b> Заполненный обходной лист отдать заведующему общежитием вместе с ключами от комнаты.</p>
    </div>
